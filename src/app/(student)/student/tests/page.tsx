...
export default async function StudentTestsPage() {
  ...
  // Fetch Flash Anzan TEST-type papers for this student's institution
  // + level. Vertical EXAM papers live on /student/exams (separate page).
  let query = supabase
    .from('exam_papers')
      ...
      {!hasAny && (
        ...
        >
          ...
          <p style={{ fontSize: '14px', color: '#475569', margin: 0 }}>
            Your Flash Anzan tests will appear here when they&apos;re published.
          </p>
        </div>
      )}
