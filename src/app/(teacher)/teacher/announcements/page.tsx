...
import AnnouncementsClient, { type AnnouncementCard, type Level } from '@/app/(admin)/admin/announcements/announcements-client';

export const instant = false;

export default async function TeacherAnnouncementsPage() {
  // Use requireRole with 'teacher' explicitly to enforce scope
  const authResult = await requireRole('teacher');
  ...
  // The server action 'createAnnouncement' enforces creation permissions natively.
