...
- Name: smoke.spec.ts >> @smoke Student authentication and dashboard navigation >> SM-02: unauthenticated /student/dashboard redirects to /login
- Location: e2e\smoke.spec.ts:61:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/student/dashboard
Call log:
  - navigating to "http://localhost:3000/student/dashboard", waiting until "load"
