...
- Name: smoke.spec.ts >> @smoke Student authentication and dashboard navigation >> SM-03: unauthenticated /admin/dashboard redirects to /login
- Location: e2e\smoke.spec.ts:69:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/admin/dashboard
Call log:
