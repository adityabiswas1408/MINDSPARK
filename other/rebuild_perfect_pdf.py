...
src_pdf_path = r'A:\MS\extracted_pdf_pages.json'
base_orig_pdf = r'C:\Users\ADI\Downloads\MINDSPARK-Mockups-Review.pdf'
final_pdf_path = r'A:\MS\MINDSPARK — Final Mockups.pdf'
downloads_pdf_path = r'C:\Users\ADI\Downloads\MINDSPARK-Mockups-Review.pdf'
backup_pdf_path = r'C:\Users\ADI\Downloads\MINDSPARK-Final-Mockups.pdf'
...
# Flash Anzan 4 Interactive Screens to insert with exact matched formatting
flash_screens = [
    {
...
# Helper to copy an original page and re-index the footer
...
# 3. Screens 1 to 9 (original pages 2 to 10)
...
# 6. Remaining Student screens (original pages 12 to 29 -> screens 15 to 32)
...
# 8. Admin screens (original pages 31 to 62 -> screens 33 to 64)
...
shutil.copy2(final_pdf_path, backup_pdf_path)
